@extends('layouts.app', [
'namePage' => 'Subscrition Plan for Notes',
                           ...
                           <div class="col-md-12">
                                 ...
                                 <div class="tab-content" id="myTabContent">
                                   <div class="tab-pane fade show active my-4" id="bams" role="tabpanel" aria-labelledby="home-tab">
                                     {{csrf_field()}}
                                     {!! Form::open(['action' => 'NotesPurcheseController@store','method' => 'POST','enctype' => 'multipart/form-data','files' => true]) !!}
                                     <div class="row">
                                     <div class="col-md-4">
                                   ...
                                   <div class="tab-pane fade my-4" id="samhita" role="tabpanel" aria-labelledby="profile-tab">
                                     {{csrf_field()}}
                                     {!! Form::open(['action' => ['NotesPurcheseController@store'], 'method' => 'POST']) !!}
                                     <div class="row">
                                     <div class="col-md-4">
                                             <div class="form-group ">
