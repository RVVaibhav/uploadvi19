...
use Vision\Notes_purchese;

class NotesPurcheseController extends Controller
{
    /**
    ...
    public function index(){
      ...
      return view('notesPurches.indexnotes');
         ...
         if($tabId == 1){
           $validatedData =$request->validate([
             ...
             'user_bio' => 'required',
              ...
              $post->save();
              return redirect('/notes')->with('success', ' Subscription BAMS Add Successfully!');
         }else if($tabId == 2) {
                  $validatedData =$request->validate([
                    'charaka_p' => 'required',
                    'Sushrut_p' => 'required',
                  ...
                  $post->save();
                return redirect('/notes')->with('success', 'Subscription SAMHITA Add Successfully!');
         }else if($tabId == 3) {
           $validatedData =$request->validate([
